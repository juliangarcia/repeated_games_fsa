 ...
 * 
 */
public class AgentBasedPayoffSimulation {
	...
	private double changingStateProbability;
	private double r;
	...
	private int timeStepsPerEstimate;
	...
	private static AgentBasedPayoffSimulation loadFromFile(String string)
			throws IOException {
		File file = new File(string);
		Gson gson = new Gson();
		String json = Files.toString(file, Charsets.UTF_8);
		AgentBasedPayoffSimulation sim = gson.fromJson(json,
				AgentBasedPayoffSimulation.class);
		sim.init();
		return sim;
	}

	public static String exampleJson() {
		AgentBasedPayoffSimulation app = new AgentBasedPayoffSimulation();
	...
	public static void runApp(String filename) throws IOException {
		...
		AgentBasedPayoffSimulation app = AgentBasedPayoffSimulation
